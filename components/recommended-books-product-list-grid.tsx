import { RecommendedBooksProducts } from '@/app/lib/product-data-tables';
const RecommendedBooksProducts2 = await RecommendedBooksProducts;
        ...
        <div className="bg-transparent font-tommy my-8">
            ...
            <div className="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    {RecommendedBooksProducts2.map((product) => (
