...
const RecommendedBooksProducts = [
  {
    id: 1,
    name: 'Basic Tee',
    href: '#',
...
const RecommendedMerchProducts = [
  {
    id: 1,
    name: 'Basic Tee',
    href: '#',
...
export { productsBooks, productsMerchandise, RecommendedBooksProducts, RecommendedMerchProducts };
