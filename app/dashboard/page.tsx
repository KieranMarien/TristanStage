        ...
        <div className="min-h-screen">
            ...
            <div className="flex items-center justify-center justify-self-center mt-8">
                <label className="inline-flex items-center cursor-pointer">
                    ...
                    <a href="/3D-Navigation">
                        <div
                            className="relative w-11 h-6 bg-red-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                    </a>
                    <span className="ms-3 text-sm font-medium text-gray-700">Immerse yourself</span>
                    <span className="ms-3 text-sm font-medium text-gray-400">I dare you</span>
                </label>
            </div>
